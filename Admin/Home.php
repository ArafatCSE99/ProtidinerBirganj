...
<html lang="en">
  <head>
    ...
    <title>প্রতিদিনের বীরগঞ্জ | Home</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
      ...
      <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row">
        <div class="navbar-brand-wrapper d-flex align-items-center">
          ...
          <h5 style='color:white;'>প্রতিদিনের বীরগঞ্জ</h5>
          ...
          <ul class="navbar-nav navbar-nav-right ml-auto">
            ...
            <li class="nav-item dropdown d-none d-xl-inline-flex user-dropdown">
              <a class="nav-link dropdown-toggle" id="UserDropdown" href="#" data-toggle="dropdown" aria-expanded="false">
                <img class="img-xs rounded-circle ml-2" src="images/faces/face8.jpg" alt="Profile image"> <span class="font-weight-normal"> Md Abdur Razzak </span></a>
              <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                <div class="dropdown-header text-center">
                  <img class="img-md rounded-circle" src="images/faces/face8.jpg" alt="Profile image">
                  <p class="mb-1 mt-3">Md Abdur Razzak</p>
                  <p class="font-weight-light text-muted mb-0">abdurrazzak@gmail.com</p>
        </div>
            ...
            <li class="nav-item nav-profile">
              <a href="#" class="nav-link">
                ...
                <div class="text-wrapper">
                  <p class="profile-name">Md Abdur Razzak </p>
