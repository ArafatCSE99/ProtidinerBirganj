...
<div class="row">
              <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">News Paper Basic Info</h4>
                    
                    <form class="forms-sample">
                      <div class="form-group">
                        <label for="exampleInputUsername1">News Paper Name</label>
                        <input type="text" class="form-control" id="npn" placeholder="News Paper Name" value="<?php echo $npn; ?>">
                      </div>
                      <div class="form-group">
